...
const Sidebar = () => {
  ...
  return (
    <div className="bg-white w-[300px] max-h-screen p-4 shrink-0">
      <div className="flex items-center gap-4">
        <img className="size-12 rounded-lg" src="/vercel.svg" alt="logo" />
        <h2 className="text-[20px] font-semibold">ShopTouch</h2>
      </div>
